#import json - Commented out as it's not used. Remove if JSON serialization is not intended.
import uuid 
...
class BaseModel:
    def __init__(self, *args, **kwargs):
        ...
        # Assign a unique ID, turn it into a string format and initialize timestamps
    ...
    def __str__(self):
        ...
        # The following line is an alternative implementation, kept for reference
    ...
    def to_dict(self):
        # Convert the instance to a dictionary, formatting dates as ISO 8601 strings
